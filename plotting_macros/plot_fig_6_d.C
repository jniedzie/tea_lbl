...
// ------------>Primitives in pad: diphotonSR_rapidity_1
   ...
   diphotonSR_rapidity_1->SetBottomMargin(0);
...
// ------------>Primitives in pad: diphotonSR_rapidity_2
   ...
   TH1D *ratio_uncertainty_diphotonSR_rapidity__15 = new TH1D("ratio_uncertainty_diphotonSR_rapidity__15","diphotonSR_rapidity",7,-2.2,2.2);
...
tex->SetNDC();
   ...
   diphotonSR_rapidity->SaveAs("Figure_006_d.pdf");
}
